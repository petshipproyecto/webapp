            ...
            <Aux>
                <ul className="navbar-nav ml-auto">
                     <li className={this.props.rtlLayout ? 'm-r-15' : 'm-l-15'}>
                        <a href='/forms/NewPet'><i aria-describedby="tooltip-bottom" className="icon feather icon-plus-circle"/></a>
                        <button type="button" class="btn btn-warning" aria-describedby="tooltip-bottom">Bottom</button>
                    </li> 
                    <li>
                            ...
                            <Dropdown.Menu alignRight className="notification">
                                <div className="noti-head">
                                    ...
                                    <div className="float-right">
                                        <a href={DEMO.BLANK_LINK} className="m-r-10">marcar como leido</a>
